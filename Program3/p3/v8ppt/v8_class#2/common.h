...
/**
* read a file and return its contents as a string * @param name The name of the file to read
*/
 ...
 */
bool load_run_script(const std::string &script, const v8::Handle<v8::Context> &context) {
